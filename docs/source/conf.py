# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-qeq
#
...
html_use_opensearch = 'http://aiida-qeq.readthedocs.io'
...
htmlhelp_basename = 'aiida-qeq-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_qeq')
